...
public class UserService {
	...
	public User registerUser(AdminUserDTO userDTO, String password) {
		...
		updateUserCompany(newUser, userDTO.getCompany().getId());
	...
	public Optional<AdminUserDTO> updateUser(AdminUserDTO userDTO) {
		return Optional
			...
			.map(user -> {
				...
				AppUser appUser = updateUserCompany(user, userDTO.getCompany().getId());
	...
	public Optional<AppUser> getUserWithAuthoritiesByLogin(String login) {
		return appUserRepository.findOneWithAuthoritiesAndCompanyByUser_Login(login);
