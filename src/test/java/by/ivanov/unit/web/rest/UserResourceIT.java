...
import by.ivanov.unit.service.mapper.UserMapper;
...
class UserResourceIT {
	...
	private static final Long DEFAULT_COMPANY_ID = 3L;
	...
	void createUser() throws Exception {
		...
		managedUserVM.setAuthorities(Collections.singleton(AuthoritiesConstants.ROLE_USER));
		managedUserVM.setCompanyId(DEFAULT_COMPANY_ID);
	...
	void getAllUsers() throws Exception {
		...
		restUserMockMvc
			...
			.andExpectAll(status().isOk(),
				...
				jsonPath("$.[*].login").value(hasItem(DEFAULT_LOGIN)),
	...
	void testUserDTOtoUser() {
		...
		userDTO.setAuthorities(Collections.singleton(AuthoritiesConstants.ROLE_USER));
		...
		assertThat(user.getAuthorities()).extracting("name").containsExactly(AuthoritiesConstants.ROLE_USER);
	}
	...
	void testUserToUserDTO() {
		...
		assertThat(userDTO.getAuthorities()).containsExactly(AuthoritiesConstants.ROLE_USER);
	...
	void testAuthorityEquals() {
		...
		authorityA.setName(AuthoritiesConstants.ROLE_USER);
		assertThat(authorityA).isNotEqualTo(authorityB);

		authorityB.setName(AuthoritiesConstants.ROLE_USER);
