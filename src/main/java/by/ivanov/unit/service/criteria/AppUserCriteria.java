...
/**
 * Criteria class for the {@link by.ivanov.unit.domain.AppUser} entity. This class is used
 * in {@link by.ivanov.unit.web.rest.AppUserResource} to receive all the possible filtering options from
...
public class AppUserCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, userId, companyId, distinct);
    }
