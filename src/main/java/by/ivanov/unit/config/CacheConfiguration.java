...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, by.ivanov.unit.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, by.ivanov.unit.repository.UserRepository.USERS_BY_EMAIL_CACHE);
