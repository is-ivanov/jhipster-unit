...
describe('PunchList Management Component', () => {
  let comp: PunchListComponent;
  let fixture: ComponentFixture<PunchListComponent>;
  let service: PunchListService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'punch-list', component: PunchListComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PunchListComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.punchLists?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
